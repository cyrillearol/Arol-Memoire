...
<template>
    ...
    <AuthenticatedLayout>
        <div class="grid gap-8 xl:grid-cols-[360px_1fr]">
            <aside class="tl-card h-fit p-5 sm:p-6">
                ...
                <h1 class="mt-5 break-words text-2xl font-bold sm:text-3xl">{{ userItem.name }}</h1>
            ...
            <section class="space-y-6">
                <div v-if="userItem.role === 'tuteur'" class="tl-card p-5 sm:p-6">
                ...
                <div class="tl-card p-5 sm:p-6">
                    ...
                    <div v-if="studentBookings.length" class="mt-4 space-y-3">
                        <div v-for="booking in studentBookings" :key="booking.id" class="rounded-lg bg-tutor-surface p-4">
                            ...
                            <p class="break-words text-sm text-slate-600">{{ booking.other }} · {{ booking.scheduled_label }} · {{ booking.status }}</p>
                        </div>
                    </div>
