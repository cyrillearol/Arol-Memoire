        ...
        <div class="mt-8 grid gap-6 xl:grid-cols-[1fr_320px]">
            <section class="space-y-6">
                ...
                <div class="tl-card p-5 sm:p-6">
                    ...
                    <form class="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-[1fr_1fr_1fr_auto]" @submit.prevent="addAvailability">
                    ...
                    <div v-if="availabilities.length" class="mt-5 grid gap-3 md:grid-cols-2">
                        <div v-for="availability in availabilities" :key="availability.id" class="flex flex-col gap-3 rounded-lg border border-slate-200 bg-tutor-surface px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
